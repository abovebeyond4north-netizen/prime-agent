...
replace_once(compaction, "export async function generateSummary(\n\tcurrentMessages: AgentMessage[],\n\tmodel: Model<any>,\n\treserveTokens: number,\n\tapiKey: string,\n\theaders?: Record<string, string>,\n\tsignal?: AbortSignal,\n\tcustomInstructions?: string,\n\tpreviousSummary?: string,\n\tthinkingLevel?: ThinkingLevel,\n\tretry?: ProviderRetryPolicy,\n): Promise<SummarySlice> {", "export async function generateSummary(\n\tcurrentMessages: AgentMessage[],\n\tmodel: Model<any>,\n\treserveTokens: number,\n\tapiKey: string,\n\theaders?: Record<string, string>,\n\tsignal?: AbortSignal,\n\tcustomInstructions?: string,\n\tpreviousSummary?: string,\n\tthinkingLevel?: ThinkingLevel,\n\tretry?: ProviderRetryPolicy,\n\tsessionId?: string,\n): Promise<SummarySlice> {")
...
replace_once(compaction, "\t\t\t\t\t\t\tpreviousSummary,\n\t\t\t\t\t\t\tthinkingLevel,\n\t\t\t\t\t\t\tretry,\n\t\t\t\t\t\t),", "\t\t\t\t\t\t\tpreviousSummary,\n\t\t\t\t\t\t\tthinkingLevel,\n\t\t\t\t\t\t\tretry,\n\t\t\t\t\t\t\tsessionId,\n\t\t\t\t\t\t),")
replace_once(compaction, "\t\t\t\t\tcallHeaders,\n\t\t\t\t\tsignal,\n\t\t\t\t\tthinkingLevel,\n\t\t\t\t\tretry,\n\t\t\t\t),", "\t\t\t\t\tcallHeaders,\n\t\t\t\t\tsignal,\n\t\t\t\t\tthinkingLevel,\n\t\t\t\t\tretry,\n\t\t\t\t\tsessionId,\n\t\t\t\t),")
replace_once(compaction, "\t\t\t\tpreviousSummary,\n\t\t\t\tthinkingLevel,\n\t\t\t\tretry,\n\t\t\t),", "\t\t\t\tpreviousSummary,\n\t\t\t\tthinkingLevel,\n\t\t\t\tretry,\n\t\t\t\tsessionId,\n\t\t\t),")
...
replace_once(refinement, "\t\t\t\t{ maxTokens: refinementMaxOutputTokens(model), signal, apiKey, headers },", "\t\t\t\t{ maxTokens: refinementMaxOutputTokens(model), signal, apiKey, headers, sessionId },")
replace_once(refinement, "\tsignal?: AbortSignal,\n\tthinkingLevel?: ThinkingLevel,\n\tretry?: ProviderRetryPolicy,\n): Promise<AutoRefineReview> {", "\tsignal?: AbortSignal,\n\tthinkingLevel?: ThinkingLevel,\n\tretry?: ProviderRetryPolicy,\n\tsessionId?: string,\n): Promise<AutoRefineReview> {")
replace_once(refinement, "\t\t\t\t{ maxTokens: autoRefineReviewMaxOutputTokens(model), signal, apiKey, headers },", "\t\t\t\t{ maxTokens: autoRefineReviewMaxOutputTokens(model), signal, apiKey, headers, sessionId },")
